...
import org.daylight.numismaticscalculator.forge.replacements.ForgeModSettingsScreen;
...
public class ForgeRegisterListenersEvent implements IRegisterListenersEvent {
    ...
    public boolean isModSettingsScreen() {
        return delegate.getScreen() instanceof ForgeModSettingsScreenImpl;
    }
    ...
    public IModSettingsScreen getAsModSettingsScreen() {
        return new ForgeModSettingsScreen((ForgeModSettingsScreenImpl) delegate.getScreen());
    }
}
