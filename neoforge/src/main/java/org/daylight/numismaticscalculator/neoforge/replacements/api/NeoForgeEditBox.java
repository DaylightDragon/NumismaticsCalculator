...
public class NeoForgeEditBox implements IEditBox {
    private final EditBox delegate;

    public NeoForgeEditBox(Font font, int x, int y, int width, int height, Component component) {
