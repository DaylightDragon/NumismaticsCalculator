package org.daylight.numismaticscalculator.neoforge.ui;
...
public class NeoForgeSelectionRenderer {
    public static void renderSelection(@NotNull GuiGraphics g, AbstractContainerScreen<?> screen) {
        IAbstractContainerScreen<?> veryAbstractContainerScreen = new NeoForgeAbstractContainerScreen<>(screen);
