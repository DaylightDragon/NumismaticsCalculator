package org.daylight.numismaticscalculator.neoforge.util;
...
public class ForgeDrawingUtils implements IDrawingUtils {
    ...
    public void fill(IGuiGraphics graphics, int xMin, int yMin, int xMax, int yMax, int bgColor, int outlineWidth, int outlineColor) {
        if(!(graphics instanceof NeoForgeGuiGraphics forgeGuiGraphics)) throw new IllegalArgumentException();
