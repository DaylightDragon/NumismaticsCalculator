...
public class NeoForgeAbstractContainerMenu implements IAbstractContainerMenu {
    private final AbstractContainerMenu delegate;

    public NeoForgeAbstractContainerMenu(AbstractContainerMenu delegate) {
    ...
    public List<ISlot> getSlots() {
        ...
        delegate.slots.forEach(slot -> slots.add(new NeoForgeSlot(slot)));
        return slots;
    }
}
